...
class _AdminEventsScreenState extends State<AdminEventsScreen> {
              ...
              return Card(
                ...
                child: ListTile(
                  ...
                  trailing: Row(
                    ...
                    children: [
                      IconButton(onPressed: () => _showEventDialog(context, eventService, event: e), icon: const Icon(Icons.edit_outlined)),
                      IconButton(
                        onPressed: () => _confirmDelete(context, eventService, e),
  ...
  void _showEventDialog(BuildContext context, EventService service, {EventModel? event}) {
              ...
              child: Column(
                ...
                children: [
                  ...
                  DropdownButtonFormField<EventType>(
                    ...
                    items: EventType.values.map((k) => DropdownMenuItem(value: k, child: Text(k.name.toUpperCase()))).toList(),
                  ...
                  ListTile(
                    ...
                    subtitle: Text(DateFormat.yMMMd().add_jm().format(selectedDate)),
                  ...
                  if (!isFree)
                    TextField(controller: priceCtrl, decoration: const InputDecoration(labelText: "Price (TND)"), keyboardType: TextInputType.number),
                ],
              ),
            ),
            actions: [
              ...
              ElevatedButton(
                onPressed: () async {
                  ...
                  if (event == null) {
                    ...
                    // Notify members
                    if (context.mounted) {
                      Provider.of<NotificationService>(context, listen: false).broadcastToGroup(
                        groupId: newEvent.group,
                        title: "New Session: ${newEvent.title}",
                        body: "A new session has been scheduled for ${DateFormat.jm().format(newEvent.date)}.",
                        type: 'event_created',
                      );
                    }
                  } else {
  ...
  void _confirmDelete(BuildContext context, EventService service, EventModel event) {
    showDialog(
      context: context,
