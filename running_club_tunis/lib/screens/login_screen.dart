...
Future<void> _handleLogin(BuildContext context) async {
  ...
  if (_password.text.length != 3 || !RegExp(r'^\d+$').hasMatch(_password.text)) {
    if (!mounted) return;
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text('CIN must be 3 digits (last 3 digits of your CIN)')),
    );
    return;
  }
  ...
  if (!success) {
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text('Login failed. Check your name and CIN last 3 digits.')),
    );
  } else {
                  ...
                  children: [
                    ...
                    Align(
                      ...
                      child: TextButton(
                        ...
                        style: TextButton.styleFrom(
                          foregroundColor: isDark ? Colors.grey : Colors.black87,
                        ),
                    ...
                    SizedBox(
                      ...
                      child: RctButton(
                        ...
                        onPressed: _isLoading ? () {} : () => _handleLogin(context),
