              ...
              return Card(
                ...
                child: ListTile(
                  leading: CircleAvatar(
                    backgroundColor: n.isRead ? Colors.grey : Theme.of(context).colorScheme.primary,
                    child: Icon(
                  ...
                  title: Text(n.title, style: TextStyle(fontWeight: n.isRead ? FontWeight.normal : FontWeight.w900)),
