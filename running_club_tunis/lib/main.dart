  ...
  Widget build(BuildContext context) {
    ...
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(create: (_) => AssistantService(RCTConnectApp.navigatorKey)),
      ],
      child: Consumer2<AuthService, ThemeService>(
        builder: (context, auth, themeService, child) {
          return MaterialApp(
            ...
            title: 'RCT Connect',
            theme: AppTheme.light(textTheme, themeService.currentColors, themeService.fontScale),
            darkTheme: AppTheme.dark(textTheme, themeService.currentColors, themeService.fontScale),
                ...
                child: Builder(
                  builder: (context) {
                    ...
                    if (user.role == UserRole.visitor) {
                      return AppShell(onToggleTheme: onToggleTheme, isGuest: true);
                    }
            ...
            routes: {
              '/signup': (_) => SignUpScreen(
                onToggleTheme: () => Provider.of<ThemeService>(context, listen: false).toggleTheme(),
              ),
            },
          );
        },
