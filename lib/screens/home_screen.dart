...
class _ActivityGrid extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GridView.count(
      ...
      children: [
        tile(Icons.groups_2_outlined, "Groupes",
            "Plusieurs niveaux\npour tous."),
        tile(Icons.run_circle_outlined, "Coaching",
            "Séances adaptées\net progressives."),
        tile(Icons.event_available_outlined, "Événements",
            "Sorties longues\n+ courses officielles."),
        tile(Icons.favorite_border, "Santé",
