          ...
          TargetContent(
            ...
            builder: (context, controller) {
              return _TutorialCard(
                ...
                body:
                    "Switch themes anytime for comfort and better visibility.",
          ...
          TargetContent(
            ...
            builder: (context, controller) {
              return _TutorialCard(
                ...
                body:
                    "Personalize the app based on your preferences or needs: 4 color-blind friendly palettes + accessible visuals.",
                primaryText: "Finish",
                onPrimary: controller.next,
              );
            },
      ...
      appBar: AppBar(
        ...
        actions: [
          if (user != null && user.role == UserRole.member)
            StreamBuilder<int>(
              stream: Provider.of<NotificationService>(context, listen: false)
              ...
              builder: (context, snapshot) {
                ...
                return Stack(
                  children: [
                    SemanticIconButton(
                      semanticId: 'profile_notifications',
          ...
          SemanticIconButton(
            key: _kThemeBtn,
            semanticId: 'profile_theme_toggle',
            ...
            child: Column(
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(
                    fontSize:
                        20 * (theme.textTheme.bodyLarge?.fontSize ?? 16) / 16,
                ...
                _OptionTile(
                  ...
                  onTap: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (_) =>
                            PersonalScreen(onToggleTheme: widget.onToggleTheme),
                      ),
                    );
                  },
                ),
